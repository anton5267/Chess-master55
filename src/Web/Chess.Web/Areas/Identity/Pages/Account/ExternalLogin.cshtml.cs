...
namespace Chess.Web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (remoteError != null)
            {
                ErrorMessage = this.localizer["Id_ExternalProviderErrorFormat", remoteError];
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
            var info = await _signInManager.GetExternalLoginInfoAsync();
            if (info == null)
            {
                ErrorMessage = this.localizer["Id_ExternalLoginInfoLoadError"];
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (info == null)
            {
                ErrorMessage = this.localizer["Id_ExternalLoginInfoLoadConfirmationError"];
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await _emailSender.SendEmailAsync(
                            Input.Email,
                            this.localizer["Id_ConfirmEmailSubject"],
                            this.localizer["Id_ConfirmEmailBody", HtmlEncoder.Default.Encode(callbackUrl)]);
