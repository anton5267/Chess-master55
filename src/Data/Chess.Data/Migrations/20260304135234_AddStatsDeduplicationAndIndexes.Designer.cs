...
namespace Chess.Data.Migrations
{
    ...
    [Migration("20260304135234_AddStatsDeduplicationAndIndexes")]
    partial class AddStatsDeduplicationAndIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Chess.Data.Models.GameEntity", b =>
                {
                    ...
                    b.HasIndex("PlayerOneUserId")
                        .HasDatabaseName("IX_games_player_one_user_id");

                    b.HasIndex("PlayerTwoUserId")
